				...
				<div class="col-12 col-md-4">
					...
					<div>
						...
						<div>
							...
							<a href="single_post_page.php?id=<?= $latest_post->get_id();?>" class="primory_btn">Read more</a>
						</div>
					</div>
				<!-- Col -->
				</div>
		...
		<section class="row all_posts">
			...
			<div class="col-12 col-5 single_post">
				...
				<div>
					...
					<a href="single_post_page.php?id=<?= $post->get_id();?>" class="primory_btn">Read more</a>
				</div>
				...
				<input type="submit" name="remove_post" value="Delete Post" class="primory_btn" />
				</form>
